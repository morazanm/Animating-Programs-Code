...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname create-st) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
...
(define BRD7-ST (create-st BOARD7     'X))
...
;; ASSUMPTIONS: Next turn for the root board is the given turn
...
(define WIN-LOST1-VAL #false)
(define WIN-LOST2-VAL (or (and (not (st-can-win? (first WIN-LOST2) (flip 'X)))
                               (st-can-win? (first WIN-LOST2) 'X))
                          (lost-can-win? (rest WIN-LOST2) 'X)))
(define WIN-LOST3-VAL (or (and (not (st-can-win? (first WIN-LOST3) (flip 'O)))
                               (st-can-win? (first WIN-LOST3) 'O))
