...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname on-x3-inlined) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
#|
...
(define 2D-POINT1-VAL (= (expt (posn-x 2D-POINT1) 3) (posn-y 2D-POINT1)))
(define 2D-POINT2-VAL (= (expt (posn-x 2D-POINT2) 3) (posn-y 2D-POINT1)))
